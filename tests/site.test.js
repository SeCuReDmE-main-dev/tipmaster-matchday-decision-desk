...
test('identity layer uses the observed official hero and palette',()=>{assert.match(identity,/trophy-hero\.jpg/);assert.match(identity,/#0f172a/i);assert.match(identity,/#ffcc33/i);assert.match(identity,/#3d8a5c/i)});
